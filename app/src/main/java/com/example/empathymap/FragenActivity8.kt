...
class FragenActivity8 : AppCompatActivity(), RobotLifecycleCallbacks {
    ...
    override fun onRobotFocusGained(qiContext: QiContext?) {
        ...
        val btnskip: Button = findViewById(R.id.button_skip8) //skip questions
        val btnpause: Button = findViewById(R.id.button_pause8) //pause timer
            ...
            timer.scheduleAtFixedRate(500L, 1000L) {
                if (!isPaused) {
                    if (seconds > timeSpanInSec) {
                        isPaused = true
                        timer.cancel()
                        this@FragenActivity8.runOnUiThread(java.lang.Runnable {
